...
title:  "How to make a 3D Thomas The Tank Engine cake with Free Template"
...
I used Ganache to sandwich the cake layers and also to cover the structure. here's my go-to [Ganache Recipe]({% link _recipes/2019-01-23-chocolate-ganache.md %})
{: .border-box .center}
...
After stacking the layers I used the [Thomas Cake Template](#the-template) to shape the structure a little more.
...
Preparing the fondant decorations or rather the details on Thomas is quite easy with the [Thomas Cake Template](#the-template)
...
Here's [how to make the face of Thomas]({% post_url 2019-01-25-thomas-train-cake %}).
...
So, this is a piece of form which is slightly smaller than the base of the train on which the train cake is to be placed so that it is a little elevated. I covered it with foil and then covered all around the visible perimeter with blue tape so that it blends nicely with the cake.
I applied some ganache on both sides of the form to stick it in place on the cake and then stick the train cake on top of it.
...
<div class="post-images">
  <img src="{{ page.images[17].url }}" alt="">
</div>
